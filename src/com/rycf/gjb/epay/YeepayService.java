...
public class YeepayService {
	...
	public static String getQueryURL() {
		return Configuration.getInstance().getValue("queryURL_1");
	}
	 ...
	 * getPayURL() : 生成支付链接
	 */
	public static String getPayURL(Map<String, String> params,String brandCode,String brandKey) {

		String p0_Cmd			= formatString(params.get("p0_Cmd"));
		String p1_MerId         = brandCode;
