		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li><a href="#">导购管理 <i class="icon-angle-right"></i> </a>
					</li>
				</ul>	
							...
							<table class="table table-striped table-hover ">
								...
								<c:forEach items="${pageResult.param}" var="temp" varStatus="status">
									<tr>
										...
										<td>${temp.getMoreUser.getMoreId }</td>
										<td>${temp.name }</td>
										<td>${temp.phone }</td>
										<td>${temp.job }</td>
										<td>
										${temp.brand.brandName }
										</td>
										<td>
										${temp.store.storeName }
										</td>
										<td>
										...
										<td>
										<my:power roleId="role143486930117862">
											<a class="btn btn-success  btn-mini changeStatu"
											 tempid="${temp.guideId }" status="${temp.status}"
