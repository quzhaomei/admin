		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span>
				</a> <a class="brand" href="index.html"><span>系统后台管理</span> </a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a class="btn dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="../login/toLogin.html"><i
		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li><a href="#">发送短信 <i class="icon-angle-right"></i> </a>
					</li>
				</ul>	
				<div class="row-fluid sortable">
					...
					<div class="box span12 brand">
						<div class="box-header" data-original-title>
							<h2>
								<i class="halflings-icon screenshot"></i><span class="break"></span>短信列表
							</h2>
							<div class="box-icon">
								<a href="#" class="toSend"><i
							...
							<div class="row-fluid">
								<div class="span12">
									<div class="dataTables_info text-left" style="padding-left:60px;" id="DataTables_Table_0_info">
										...
										<td>
										<select id="pageSelect" style='width:60px;' rel="chosen">
	...
	<footer>
		<p>
			<span style="text-align:left;float:left">&copy; 2015 <a
				...
				alt="Bootstrap_Metro_Dashboard">quzhaomei@com</a>
			</span>
		</p>
	</footer>
	<!-- start: JavaScript-->
	...
	$(".toSend").on("click",
					function() {
						...
						index = layer
								.open({
									type : 2,
									title : '<div class="box-header" data-original-title><h2><i class="halflings-icon book"></i><span class="break"></span>'
											+ title + '</h2></div>',
									shade : 0.8,
									maxmin : true, //开启最大化最小化按钮
									area : [ '1150px', '650px' ],
									content : [ 'saveOrUpdate.html?operator=toAdd'],
									end : function() {
										closeInit()
									}
								});
