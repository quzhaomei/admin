...
$(function(){
	...
	$.activeMenuItem = function() {
		...
		jQuery(".ewf-section-nav").each(function() {
			id_slide = $(this).attr("id");
			if(jQuery(this).offset().top <= pos + 100 && jQuery("#navigation li a[href$='#"+id_slide+"']").length > 0) {
				jQuery("#navigation li.active").removeClass("active");
				jQuery("#navigation li a[href$='#"+id_slide+"']").parent().addClass("active");	
			}
		});
	};
